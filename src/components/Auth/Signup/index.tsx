...
export default function Signup() {
  ...
  const registerUser = async (e: any) => {
    ...
    axios
      ...
      .catch(() => toast.error("A apărut o eroare. Încearcă din nou."));
  };
  return (
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[920px] rounded-sm border bg-white px-6 py-10 sm:px-10 md:p-[70px]">
                ...
                <p className="text-body-color mb-12 text-base font-medium">
                  Creează-ți contul pentru a începe proiecte de creare site și web design.
                </p>

                <h3 className="text-dark mb-8 text-xl">
                  Înregistrare cu rețele sociale
                </h3>
                      ...
                      <div className="mb-4 flex flex-wrap justify-between gap-4">
                        <div className="mb-4">
                          ...
                          >
                            ...
                            Prin crearea contului ești de acord cu Termenii și
                            condițiile și cu Politica de confidențialitate
                          </label>
                        </div>
                        <div className="mb-4">
