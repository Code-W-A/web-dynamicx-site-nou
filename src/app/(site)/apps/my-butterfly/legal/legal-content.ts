...
export const legalContentByLang: Record<Language, LanguageContent> = {
  ro: {
    pageTitle: "My Butterfly — Politică de confidențialitate & Termeni",
    pageSubtitle:
      "Această pagină conține documentele legale ale aplicației mobile My Butterfly: Politica de confidențialitate și Termenii și condițiile de utilizare.",
    tabRo: "RO",
    tabEn: "EN",
    ...
    privacySections: [
      {
        ...
        title: "1. Introducere",
        paragraphs: [
          "Prezenta Politică de confidențialitate explică modul în care aplicația mobilă My Butterfly prelucrează datele personale ale utilizatorilor.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Aplicația My Butterfly nu vinde produse și nu procesează plăți în aplicație.",
    ...
    termsSections: [
      {
        ...
        title: "1. Introducere",
        paragraphs: [
          "Acești Termeni și condiții reglementează utilizarea aplicației mobile My Butterfly.",
      ...
      },
      {
        ...
        paragraphs: [
          "My Butterfly oferă un chestionar și recomandări orientative pentru echipament de tenis de masă.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "My Butterfly nu procesează plăți în aplicație.",
        ],
      },
      {
  ...
  en: {
    pageTitle: "My Butterfly — Privacy Policy & Terms",
    pageSubtitle:
      "This page contains the legal documents for the My Butterfly mobile app: Privacy Policy and Terms & Conditions.",
    tabRo: "RO",
    tabEn: "EN",
    ...
    privacySections: [
      {
        ...
        paragraphs: [
          "This Privacy Policy explains how the My Butterfly mobile app processes users' personal data.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The My Butterfly app does not sell products and does not process in-app payments.",
    ...
    termsSections: [
      {
        ...
        title: "1. Introduction",
        paragraphs: [
          "These Terms & Conditions govern the use of the My Butterfly mobile app.",
      ...
      },
      {
        ...
        paragraphs: [
          "My Butterfly provides a questionnaire and informative recommendations for table tennis equipment.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "My Butterfly does not process payments in the app.",
        ],
      },
      {
