...
export const legalContentByLang: Record<Language, LanguageContent> = {
  ro: {
    pageTitle: "Cristina Zurba Tarot&Astrology — Politică de confidențialitate & Termeni",
    pageSubtitle:
      "Această pagină conține documentele legale ale aplicației mobile Cristina Zurba Tarot&Astrology: Politica de confidențialitate și Termenii și condițiile de utilizare.",
    tabRo: "RO",
    tabEn: "EN",
    ...
    privacySections: [
      {
        ...
        title: "1. Introducere",
        paragraphs: [
          "Prezenta Politică de confidențialitate explică modul în care aplicația mobilă Cristina Zurba Tarot&Astrology prelucrează datele personale ale utilizatorilor.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Datele pot fi asociate contului atunci când utilizezi funcționalitățile aplicației.",
      ...
      },
      {
        ...
        paragraphs: [
          "Folosim datele pentru furnizarea funcționalităților aplicației (cont, interpretări și conținut astrologic) și pentru suport utilizator.",
      ...
      },
      {
        ...
        paragraphs: [
          "Aplicația poate include linkuri către resurse externe relevante pentru utilizator.",
          "Aplicația Cristina Zurba Tarot&Astrology nu vinde produse și nu procesează plăți în aplicație.",
    ...
    termsSections: [
      {
        ...
        title: "1. Introducere",
        paragraphs: [
          "Acești Termeni și condiții reglementează utilizarea aplicației mobile Cristina Zurba Tarot&Astrology.",
      ...
      },
      {
        ...
        paragraphs: [
          "Cristina Zurba Tarot&Astrology oferă conținut informativ de tarot și astrologie.",
        ],
      },
      {
      ...
      },
      {
        ...
        title: "4. Recomandări",
        paragraphs: [
          "Conținutul și recomandările din aplicație au rol orientativ și informativ.",
          "Deciziile personale luate de utilizator pe baza acestui conținut aparțin exclusiv utilizatorului.",
        ],
      },
      {
        id: "terms-5-link-extern-achizitii",
        title: "5. Linkuri către site-uri externe",
        paragraphs: [
          "Aplicația nu comercializează produse direct.",
          "Utilizatorul poate fi redirecționat către site-uri externe pentru resurse suplimentare.",
          "Cristina Zurba Tarot&Astrology nu procesează plăți în aplicație.",
        ],
      },
      {
  ...
  en: {
    pageTitle: "Cristina Zurba Tarot&Astrology — Privacy Policy & Terms",
    pageSubtitle:
      "This page contains the legal documents for the Cristina Zurba Tarot&Astrology mobile app: Privacy Policy and Terms & Conditions.",
    tabRo: "RO",
    tabEn: "EN",
    ...
    privacySections: [
      {
        ...
        paragraphs: [
          "This Privacy Policy explains how the Cristina Zurba Tarot&Astrology mobile app processes users' personal data.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Data may be associated with your account when you use app features.",
      ...
      },
      {
        ...
        paragraphs: [
          "We use data to provide app features (account, tarot readings and astrology content) and user support.",
      ...
      },
      {
        ...
        paragraphs: [
          "The app may include links to external resources relevant for users.",
          "The Cristina Zurba Tarot&Astrology app does not sell products and does not process in-app payments.",
    ...
    termsSections: [
      {
        ...
        title: "1. Introduction",
        paragraphs: [
          "These Terms & Conditions govern the use of the Cristina Zurba Tarot&Astrology mobile app.",
      ...
      },
      {
        ...
        paragraphs: [
          "Cristina Zurba Tarot&Astrology provides informative tarot and astrology content.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Content and recommendations in the app are for guidance only and are provided for informational purposes.",
          "Personal decisions taken based on this content remain solely with the user.",
        ],
      },
      {
        id: "terms-5-external-purchase-link",
        title: "5. External website links",
        paragraphs: [
          "The app does not sell products directly.",
          "Users may be redirected to external websites for additional resources.",
          "Cristina Zurba Tarot&Astrology does not process payments in the app.",
        ],
      },
      {
