export const contactData = {
  ...
  whatsappHref:
    "https://wa.me/40774550758?text=Salut!%20Vreau%20o%20oferta%20pentru%20dezvoltare%20aplicatie%20mobila.",
...
export const benefits = [
  {
    title: "Construită pe obiectivele tale comerciale",
    description:
      "Definim aplicația pornind de la rezultate concrete: eficiență operațională, retenție și creștere de venit.",
  },
  {
    title: "Experiență intuitivă pentru utilizatori",
    description:
      "Fluxuri clare și interfețe moderne care reduc fricțiunea și cresc adoptarea aplicației.",
  },
  {
    title: "Livrare rapidă și structurată",
    description:
      "Lucrăm în etape validate, cu prioritizare clară, astfel încât să ajungi mai repede la lansare.",
  },
  {
    title: "Arhitectură pregătită pentru scalare",
    description:
      "Gândim fundația tehnică pentru extindere ulterioară, fără blocaje majore când crește produsul.",
  },
  {
    title: "Integrări cu API-uri și sisteme existente",
    description:
      "Conectăm aplicația cu CRM, ERP, plăți online, dashboard-uri și alte servicii esențiale.",
  },
  {
    title: "Suport tehnic și evoluție continuă",
    description:
      "Rămânem partenerul tău după lansare pentru optimizare, mentenanță și noi funcționalități.",
  },
];
