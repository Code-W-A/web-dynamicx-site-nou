...
const pagePath = "/leads/creare-site-web";

export const metadata: Metadata = {
  title: `Solicita oferta creare site web | ${siteName}`,
  description:
    "Landing page pentru campanii platite: creare site-uri web orientate pe conversie. Cere o estimare personalizata.",
  alternates: {
  ...
  openGraph: {
    title: `Creare site web - oferta rapida | ${siteName}`,
    description: "Pagina de conversie pentru lead-uri: website-uri moderne, rapide si scalabile.",
...
export default function LeadsWebSitePage() {
  const SubscriptionAlternativeSection = () => (
    <WebsiteSubscriptionAlternative
      ...
      secondaryCtaHref="/servicii/creare-site-web#preturi"
      variant="compact"
      className="bg-white"
    />
  );
