        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_1fr] lg:items-center">
          <div>
            <h1 className="text-4xl leading-tight font-bold text-black sm:text-5xl">
              Creare site-uri web si magazine online care transforma traficul in clienti
            </h1>
            ...
            <div className="rounded-3xl border border-gray-200 bg-white p-4 shadow-service">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="overflow-hidden rounded-2xl border border-gray-200 bg-gray-50">
                  ...
                  <p className="px-3 py-2 text-xs font-medium text-gray-700">Creare site web</p>
                </div>
                <div className="overflow-hidden rounded-2xl border border-gray-200 bg-gray-50">
                  {!shopImgError ? (
                    <Image
                      src="/images/services/creare-magazin-online.webp"
                      alt="Preview creare magazin online"
                      width={520}
                      height={340}
                      className="h-40 w-full object-cover"
                  ...
                  <p className="px-3 py-2 text-xs font-medium text-gray-700">Creare magazin online</p>
                </div>
              </div>
            </div>
